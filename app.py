...
df_livraisons = pd.read_csv("data/ListeTransfert_geocode (2) (1).csv", parse_dates=["DATE DU TRANSFERT"])
df_livraisons.rename(columns={"DATE DU TRANSFERT": "date"}, inplace=True)  # pour standardiser
